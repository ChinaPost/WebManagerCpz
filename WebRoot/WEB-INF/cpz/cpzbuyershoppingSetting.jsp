...
$(document).on('ready', function() {
	...
	$("#userid").val(userid);
	var shopproductid='${entity.shopproductid}';
	$("#shopproductid").val(shopproductid);
	var shopid='${entity.shopid}';
	$("#shopid").val(shopid);
	var marketid='${entity.marketid}';
	$("#marketid").val(marketid);
	var normsid='${entity.normsid}';
	$("#normsid").val(normsid);
	var buynum='${entity.buynum}';
	$("#buynum").val(buynum);
	var normsprice='${entity.normsprice}';
	$("#normsprice").val(normsprice);
...
<body>
 <form action="CpzBuyerShoppingAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
