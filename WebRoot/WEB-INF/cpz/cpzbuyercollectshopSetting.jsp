...
$(document).on('ready', function() {
	...
	var shopbusineerangeid='${entity.shopbusineerangeid}';
	$("#shopbusineerangeid").val(shopbusineerangeid);
	var isdefaultshop='${entity.isdefaultshop}';
	$("#isdefaultshop").val(isdefaultshop);
	var colletctime='${entity.colletctime}';
	$("#colletctime").val(colletctime);
...
<body>
 <form action="CpzBuyerCollectShopAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
...
<select id="isdefaultshop" name="entity.isdefaultshop" class="form-control" style="width: 187px;height:28px;margin-bottom:10px;">
				<option value="">请选择</option>
					<c:forEach var="item" items="${isdefaultshopSelectList}">	
						<c:choose>
							<c:when test="${item==entity.isdefaultshop}">								
