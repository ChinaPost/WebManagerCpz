...
$(document).on('ready', function() {
	...
	var productpic='${entity.productpic}';
	$("#productpic").val(productpic);
	var merchintro='${entity.merchintro}';
	$("#merchintro").val(merchintro);
...
<body>
 <form action="CpzSellerProductAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
