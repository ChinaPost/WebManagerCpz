...
$(document).on('ready', function() {
	...
	var datestr='${entity.datestr}';
	$("#datestr").val(datestr);
	var merchname='${entity.merchname}';
	$("#merchname").val(merchname);
	var weight='${entity.weight}';
	$("#weight").val(weight);
	var settsumprice='${entity.settsumprice}';
	$("#settsumprice").val(settsumprice);
...
<body>
 <form action="GspSalesReportAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
