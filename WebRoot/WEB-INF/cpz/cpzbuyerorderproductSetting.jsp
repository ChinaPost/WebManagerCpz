...
$(document).on('ready', function() {
	...
	var shopproductname='${entity.shopproductname}';
	$("#shopproductname").val(shopproductname);
	var levelid='${entity.levelid}';
	$("#levelid").val(levelid);
	var producttype='${entity.producttype}';
	$("#producttype").val(producttype);
	var shopnormsid='${entity.shopnormsid}';
	$("#shopnormsid").val(shopnormsid);
	var shopnormsnum='${entity.shopnormsnum}';
	$("#shopnormsnum").val(shopnormsnum);
	var shopnormsprice='${entity.shopnormsprice}';
	$("#shopnormsprice").val(shopnormsprice);
...
<body>
 <form action="CpzBuyerOrderProductAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
