...
$(document).on('ready', function() {
	...
	var picname='${entity.picname}';
	$("#picname").val(picname);
	var picshowno='${entity.picshowno}';
	$("#picshowno").val(picshowno);
	var picnorms='${entity.picnorms}';
	$("#picnorms").val(picnorms);
	var picurl='${entity.picurl}';
	$("#picurl").val(picurl);
...
<body>
 <form action="CpzPlatProductPicAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
...
<select id="picnorms" name="entity.picnorms" class="form-control" style="width: 187px;height:28px;margin-bottom:10px;">
				<option value="">请选择</option>
					<c:forEach var="item" items="${picnormsSelectList}">	
						<c:choose>
							<c:when test="${item==entity.picnorms}">								
					...
					<tr >
						...
						<td>
						<img src=".${entity.picurl }" style="display: block;width:40px;height:30px"/>
						    <input type="hidden" id="picurl" name="entity.picurl"  value="${entity.picurl }"/>
