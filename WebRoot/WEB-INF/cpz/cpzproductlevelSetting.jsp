...
$(document).on('ready', function() {
	...
	var productcategoryname='${entity.productcategoryname}';
	$("#productcategoryname").val(productcategoryname);
	var parentid='${entity.parentid}';
	$("#parentid").val(parentid);
	var parentname='${entity.parentname}';
	$("#parentname").val(parentname);
	var productcategorygrade='${entity.productcategorygrade}';
	$("#productcategorygrade").val(productcategorygrade);
...
<body>
 <form action="CpzProductLevelAction!doUpdate" method="post" enctype="multipart/form-data" name="myForm">
...
<select id="productcategorygrade" name="entity.productcategorygrade" class="form-control" style="width: 187px;height:28px;margin-bottom:10px;">
				<option value="">请选择</option>
					<c:forEach var="item" items="${productcategorygradeSelectList}">	
						<c:choose>
							<c:when test="${item==entity.productcategorygrade}">								
